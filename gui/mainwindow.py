...
class MainWindow(QMainWindow):
    ...
    def loadIconResources(self):
        self.editIcon = QIcon(resource_path("icons/edit.svg"))
        self.editIconWhite = QIcon(resource_path("icons/edit-white.svg"))
        self.playIcon = QIcon(resource_path("icons/play.svg"))
        self.playIconWhite = QIcon(resource_path("icons/play-white.svg"))
        self.pauseIcon = QIcon(resource_path("icons/pause.svg"))
        self.pauseIconWhite = QIcon(resource_path("icons/pause-white.svg"))
        self.settingsIcon = QIcon(resource_path("icons/settings.svg"))
        self.settingsIconWhite = QIcon(resource_path("icons/settings-white.svg"))
        self.discordIcon = QIcon(resource_path("icons/discord.svg"))
        self.discordIconWhite = QIcon(resource_path("icons/discord-white.svg"))
